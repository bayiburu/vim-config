...
hi Identifier ctermfg=green guibg=bg guifg=#dabfa5 gui=none
...
hi htmlLink ctermbg=0 ctermfg=6 guibg=bg guifg=fg gui=underline

hi mkdCode ctermbg=0 ctermfg=brown
hi mkdListItem ctermbg=0 ctermfg=green
hi mkdBlockquote ctermbg=0 ctermfg=brown
